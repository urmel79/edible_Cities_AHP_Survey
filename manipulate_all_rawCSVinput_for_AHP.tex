\documentclass [oneside,10pt,a4paper,ngerman,BCOR10mm,headsepline,parindent,final]{scrartcl}
    ...
    % Document parameters
    % Document title
    \title{\textbf{\textsf{Preparing raw CSV input data from survey for analytical hierarchy process (AHP)}}}\author[1]{Bj\"orn Kasper (\href{mailto:kasper.bjoern@bgetem.de}{kasper.bjoern@bgetem.de})}

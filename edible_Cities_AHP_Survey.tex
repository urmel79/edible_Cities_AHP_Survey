...
\PY{n}{func\PYZus{}adaptData2SaatyScale} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{df\PYZus{}inputData}\PY{p}{,}
  ...
  \PY{c+c1}{\PYZsh{} Return rescaled dataframe}
...
\PY{n+nf}{for }\PY{p}{(} \PY{n}{row\PYZus{}idx} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{nrow}\PY{p}{(}\PY{n}{df\PYZus{}csvInputFiles}\PY{p}{)} \PY{p}{)} \PY{p}{\PYZob{}}
  ...
  \PY{c+c1}{\PYZsh{} Adapt the encoded scale of the survey to the 17\PYZhy{}step Saaty\PYZsq{}s scale}
  \PY{c+c1}{\PYZsh{} in the input dataframes}
  \PY{n}{df\PYZus{}surveyData\PYZus{}rescaled} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{func\PYZus{}adaptData2SaatyScale}\PY{p}{(}\PY{n}{list\PYZus{}dataframes}\PY{p}{[[}\PY{l+m}{1}\PY{p}{]]}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}search\PYZus{}1}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}search\PYZus{}2}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}out}\PY{p}{)}
  
  \PY{c+c1}{\PYZsh{} Write rescaled dataframes to output CSV file}
  \PY{n+nf}{func\PYZus{}writeDataframe\PYZus{}to\PYZus{}CSVfile}\PY{p}{(}\PY{n}{str\PYZus{}output\PYZus{}path\PYZus{}prep}\PY{p}{,}
                                 ...
                                 \PY{n}{df\PYZus{}surveyData\PYZus{}rescaled}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{crit\PYZdq{}}\PY{p}{)}
\PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nf}{for }\PY{p}{(} \PY{n}{row\PYZus{}idx} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{nrow}\PY{p}{(}\PY{n}{df\PYZus{}csvInputFiles}\PY{p}{)} \PY{p}{)} \PY{p}{\PYZob{}}
  ...
  \PY{c+c1}{\PYZsh{} Adapt the encoded scale of the survey to the 17\PYZhy{}step Saaty\PYZsq{}s scale}
  \PY{c+c1}{\PYZsh{} in the input dataframes}
  \PY{n}{df\PYZus{}surveyData\PYZus{}rescaled} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{func\PYZus{}adaptData2SaatyScale}\PY{p}{(}\PY{n}{list\PYZus{}dataframes}\PY{p}{[[}\PY{l+m}{2}\PY{p}{]]}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}search\PYZus{}1}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}search\PYZus{}2}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}out}\PY{p}{)}
  ...
  \PY{n+nf}{func\PYZus{}writeDataframe\PYZus{}to\PYZus{}CSVfile}\PY{p}{(}\PY{n}{str\PYZus{}output\PYZus{}path\PYZus{}prep}\PY{p}{,}
                                 \PY{n}{df\PYZus{}csvInputFiles}\PY{p}{[}\PY{n}{row\PYZus{}idx}\PY{p}{,} \PY{n}{filenames}\PY{p}{]}\PY{p}{,}
                                 \PY{n}{df\PYZus{}surveyData\PYZus{}rescaled}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{env\PYZdq{}}\PY{p}{)}
\PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nf}{for }\PY{p}{(} \PY{n}{row\PYZus{}idx} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{nrow}\PY{p}{(}\PY{n}{df\PYZus{}csvInputFiles}\PY{p}{)} \PY{p}{)} \PY{p}{\PYZob{}}
  ...
  \PY{c+c1}{\PYZsh{} Adapt the encoded scale of the survey to the 17\PYZhy{}step Saaty\PYZsq{}s scale}
  \PY{c+c1}{\PYZsh{} in the input dataframes}
  \PY{n}{df\PYZus{}surveyData\PYZus{}rescaled} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{func\PYZus{}adaptData2SaatyScale}\PY{p}{(}\PY{n}{list\PYZus{}dataframes}\PY{p}{[[}\PY{l+m}{3}\PY{p}{]]}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}search\PYZus{}1}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}search\PYZus{}2}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}out}\PY{p}{)}
  ...
  \PY{n+nf}{func\PYZus{}writeDataframe\PYZus{}to\PYZus{}CSVfile}\PY{p}{(}\PY{n}{str\PYZus{}output\PYZus{}path\PYZus{}prep}\PY{p}{,}
                                 \PY{n}{df\PYZus{}csvInputFiles}\PY{p}{[}\PY{n}{row\PYZus{}idx}\PY{p}{,} \PY{n}{filenames}\PY{p}{]}\PY{p}{,}
                                 \PY{n}{df\PYZus{}surveyData\PYZus{}rescaled}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{soc\PYZdq{}}\PY{p}{)}
\PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nf}{for }\PY{p}{(} \PY{n}{row\PYZus{}idx} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{nrow}\PY{p}{(}\PY{n}{df\PYZus{}csvInputFiles}\PY{p}{)} \PY{p}{)} \PY{p}{\PYZob{}}
  ...
  \PY{c+c1}{\PYZsh{} Adapt the encoded scale of the survey to the 17\PYZhy{}step Saaty\PYZsq{}s scale}
  \PY{c+c1}{\PYZsh{} in the input dataframes}
  \PY{n}{df\PYZus{}surveyData\PYZus{}rescaled} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{func\PYZus{}adaptData2SaatyScale}\PY{p}{(}\PY{n}{list\PYZus{}dataframes}\PY{p}{[[}\PY{l+m}{4}\PY{p}{]]}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}search\PYZus{}1}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}search\PYZus{}2}\PY{p}{,}
                                                      \PY{n}{vec\PYZus{}colnames\PYZus{}out}\PY{p}{)}
  ...
  \PY{n+nf}{func\PYZus{}writeDataframe\PYZus{}to\PYZus{}CSVfile}\PY{p}{(}\PY{n}{str\PYZus{}output\PYZus{}path\PYZus{}prep}\PY{p}{,}
                                 \PY{n}{df\PYZus{}csvInputFiles}\PY{p}{[}\PY{n}{row\PYZus{}idx}\PY{p}{,} \PY{n}{filenames}\PY{p}{]}\PY{p}{,}
                                 \PY{n}{df\PYZus{}surveyData\PYZus{}rescaled}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{eco\PYZdq{}}\PY{p}{)}
\PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{df\PYZus{}attributes\PYZus{}labels} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{data.table}\PY{p}{(}
  ...
  \PY{n}{labels} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Environment\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Society\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Economy\PYZdq{}}\PY{p}{,}
             ...
             \PY{l+s}{\PYZdq{}}\PY{l+s}{Food Quality and Safety\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Local Value Chains\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Food Affordability\PYZdq{}}\PY{p}{)}\PY{p}{,}
  \PY{n}{descriptions} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{main criterion\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{main criterion\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{main criterion\PYZdq{}}\PY{p}{,}
                   \PY{l+s}{\PYZdq{}}\PY{l+s}{environmental sub\PYZhy{}criterion\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{environmental sub\PYZhy{}criterion\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{environmental sub\PYZhy{}criterion\PYZdq{}}\PY{p}{,}
                   \PY{l+s}{\PYZdq{}}\PY{l+s}{social sub\PYZhy{}criterion\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{social sub\PYZhy{}criterion\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{social sub\PYZhy{}criterion\PYZdq{}}\PY{p}{,}
                   \PY{l+s}{\PYZdq{}}\PY{l+s}{economic sub\PYZhy{}criterion\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{economic sub\PYZhy{}criterion\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{economic sub\PYZhy{}criterion\PYZdq{}}\PY{p}{)}
\PY{p}{)}

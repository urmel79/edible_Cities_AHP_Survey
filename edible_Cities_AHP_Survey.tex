...
(\texttt{data.table} inherits from \texttt{data.frame}).
...
The package \texttt{ggplot2} is used to plot diagrams.
...
The \texttt{display\_markdown()} function from the package
\texttt{IRdisplay} renders the markdown table in the Jupyter notebook as
well as in the compiled PDF version.
...
\end{tcolorbox}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{edible_Cities_AHP_Survey_files/edible_Cities_AHP_Survey_75_0.png}\end{center}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{edible_Cities_AHP_Survey_files/edible_Cities_AHP_Survey_75_1.png}\end{center}
        \caption{Series of violin plots that display the priorities and consistency ratios of all participants}
        \label{fig:violins_all_attributes}
    \end{figure}
    
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{edible_Cities_AHP_Survey_files/edible_Cities_AHP_Survey_75_2.png}\end{center}
        \caption{Series of violin plots that display the priorities and consistency ratios of all participants}
        \label{fig:violins_all_attributes}
    \end{figure}
    
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{edible_Cities_AHP_Survey_files/edible_Cities_AHP_Survey_75_3.png}\end{center}
        \caption{Series of violin plots that display the priorities and consistency ratios of all participants}
        \label{fig:violins_all_attributes}
    \end{figure}

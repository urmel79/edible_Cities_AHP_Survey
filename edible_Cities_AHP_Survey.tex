\documentclass [oneside,10pt,a4paper,ngerman,BCOR10mm,headsepline,parindent,final]{scrartcl}
    ...
    % Document parameters
    % Document title
    \title{\textbf{\textsf{Performing the Analytic Hierarchy Process with survey data from \emph{SoSci Survey} and R-package \emph{ahpsurvey}}}}\author[1]{Bj\"orn Kasper (\href{mailto:kasper.bjoern@bgetem.de}{kasper.bjoern@bgetem.de})}
...
\makeatother
    ...
    \hypersetup{
      ...
      pdftitle=Performing the Analytic Hierarchy Process with survey data from \emph{SoSci Survey} and R-package \emph{ahpsurvey},
      colorlinks=true,
      urlcolor=urlcolor,
      linkcolor=linkcolor,
      citecolor=citecolor,
...
\subsection{Functions to prepare the survey data for further
...
\subsubsection{Function to format dataframes as a markdown

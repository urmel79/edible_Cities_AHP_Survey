...
\PY{n}{func\PYZus{}visuPriosCRs} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{df\PYZus{}surveyData}\PY{p}{,} \PY{n}{df\PYZus{}cr}\PY{p}{,} \PY{n}{arr\PYZus{}cr}\PY{p}{,} \PY{n}{consistency\PYZus{}thres}\PY{o}{=}\PY{l+m}{0.1}\PY{p}{,} \PY{n}{vec\PYZus{}attributes}\PY{p}{,} \PY{n}{df\PYZus{}eigentrue}\PY{p}{,} \PY{n}{vec\PYZus{}labels}\PY{p}{,} \PY{n}{str\PYZus{}image\PYZus{}filename}\PY{p}{)} \PY{p}{\PYZob{}}
  ...
  \PY{n}{df\PYZus{}surveyData} \PY{o}{\PYZpc{}\PYZgt{}\PYZpc{}}
...
\PY{c+c1}{\PYZsh{} img \PYZlt{}\PYZhy{} image\PYZus{}read(str\PYZus{}image\PYZus{}filename)}
\PY{c+c1}{\PYZsh{} image\PYZus{}info(img)}
\PY{c+c1}{\PYZsh{} img \PYZlt{}\PYZhy{} image\PYZus{}scale(img, \PYZdq{}600\PYZdq{})}
\PY{n}{img} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{image\PYZus{}graph}\PY{p}{(}\PY{n}{width} \PY{o}{=} \PY{l+m}{400}\PY{p}{,} \PY{n}{height} \PY{o}{=} \PY{l+m}{400}\PY{p}{,} \PY{n}{res} \PY{o}{=} \PY{l+m}{12}\PY{p}{)}
\PY{n}{img} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{image\PYZus{}read}\PY{p}{(}\PY{n}{str\PYZus{}image\PYZus{}filename}\PY{p}{)}
 
\PY{c+c1}{\PYZsh{} print(img)}
\PY{n+nf}{image\PYZus{}display}\PY{p}{(}\PY{n}{img}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}, frame=single, framerule=2mm, rulecolor=\color{outerrorbackground}]
Error in magick\_image\_display(image, animate): R: unable to open X server `' @ error/animate.c/AnimateImages/301
Traceback:

1. image\_display(img)
2. magick\_image\_display(image, animate)
    \end{Verbatim}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{30}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} \PYZsh{} ggplot2::qplot(factor(cyl), data = mtcars, fill = factor(gear))}
\PY{c+c1}{\PYZsh{} }
\PY{c+c1}{\PYZsh{} \PYZsh{} Produce graphic}
\PY{c+c1}{\PYZsh{} fig \PYZlt{}\PYZhy{} image\PYZus{}graph(width = 800, height = 600, res = 96)}
\PY{c+c1}{\PYZsh{} ggplot2::qplot(factor(cyl), data = mtcars, fill = factor(gear))}
\PY{c+c1}{\PYZsh{} invisible(dev.off())}
\PY{c+c1}{\PYZsh{} }
\PY{c+c1}{\PYZsh{} print(fig)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} library(ggplot2)}
\PY{c+c1}{\PYZsh{} \PYZsh{} install.packages(\PYZdq{}png\PYZdq{})}
\PY{c+c1}{\PYZsh{} library(png)}
\PY{c+c1}{\PYZsh{} }
\PY{c+c1}{\PYZsh{} img1 \PYZlt{}\PYZhy{} readPNG(str\PYZus{}image\PYZus{}filename, native = TRUE, info = FALSE)}
\PY{c+c1}{\PYZsh{} print(img1)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} \PYZsh{}install.packages(\PYZdq{}rsvg\PYZdq{})}
\PY{c+c1}{\PYZsh{} library(rsvg)}
\PY{c+c1}{\PYZsh{} library(magick)}
\PY{c+c1}{\PYZsh{} tiger \PYZlt{}\PYZhy{} image\PYZus{}read\PYZus{}svg(\PYZsq{}http://jeroen.github.io/images/tiger.svg\PYZsq{}, width = 350)}
\PY{c+c1}{\PYZsh{} print(tiger)}
\end{Verbatim}
\end{tcolorbox}

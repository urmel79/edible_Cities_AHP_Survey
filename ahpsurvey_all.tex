...
\PY{n+nf}{print.data.frame}\PY{p}{(}\PY{n}{df\PYZus{}attributes\PYZus{}labels}\PY{p}{,} \PY{n}{right}\PY{o}{=}\PY{k+kc}{FALSE}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
2  Soci Society
3  Econ Economy
4  Clim Microclimate and Hydrology
5  BDiv Biodiversity
6  CiEc Circular economy
7  KEdu Knowledge and Education
8  Comm Community Building
9  Part Participation
10 Qual Food Quality and Safety
11 LVCs Local Value Chains
12 Affo Food Affordability
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_50_0.png}\end{center}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_50_2.png}\end{center}
        \caption{Series of violin plots that display the priorities and consistency ratios of practitioners and experts}
        \label{fig:violins_all_attributes}
    \end{figure}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df\PYZus{}csvInputFiles} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{df\PYZus{}csvInputFiles\PYZus{}all}
\PY{n}{row\PYZus{}start} \PY{o}{=} \PY{l+m}{1}
\PY{n}{row\PYZus{}end} \PY{o}{=} \PY{l+m}{3}
...
\PY{n+nf}{for }\PY{p}{(} \PY{n}{file\PYZus{}idx} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{nrow}\PY{p}{(}\PY{n}{df\PYZus{}csvInputFiles}\PY{p}{)} \PY{p}{)} \PY{p}{\PYZob{}}
    ...
    \PY{n}{table\PYZus{}out} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{kable}\PY{p}{(}
        \PY{n}{df\PYZus{}gmean}\PY{p}{,}
        \PY{n}{format} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{markdown\PYZdq{}}\PY{p}{,}
        \PY{c+c1}{\PYZsh{} digits = 2,}
        \PY{n}{caption} \PY{o}{=} \PY{n+nf}{paste}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Aggregated weights for \PYZdq{}}\PY{p}{,} \PY{n}{str\PYZus{}file\PYZus{}description}\PY{p}{)}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df\PYZus{}multiply\PYZus{}test} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{data.table}\PY{p}{(}
    \PY{n}{col.a} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+m}{1}\PY{p}{,} \PY{l+m}{5}\PY{p}{,} \PY{l+m}{4}\PY{p}{)}\PY{p}{,}
    \PY{n}{col.b} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+m}{8}\PY{p}{,} \PY{l+m}{4}\PY{p}{,} \PY{l+m}{7}\PY{p}{)}
\PY{p}{)}

\PY{n+nf}{print.data.frame}\PY{p}{(}\PY{n}{df\PYZus{}multiply\PYZus{}test}\PY{p}{,} \PY{n}{right}\PY{o}{=}\PY{k+kc}{TRUE}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df\PYZus{}multiply\PYZus{}test}\PY{o}{\PYZdl{}}\PY{n}{col.result} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{df\PYZus{}multiply\PYZus{}test}\PY{o}{\PYZdl{}}\PY{n}{col.b} \PY{o}{*} \PY{l+m}{2}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} install.packages(\PYZdq{}knitr\PYZdq{})}
\PY{n+nf}{library}\PY{p}{(}\PY{n}{knitr}\PY{p}{)}
\PY{n+nf}{library}\PY{p}{(}\PY{n}{IRdisplay}\PY{p}{)}

\PY{n}{table\PYZus{}kbl} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{kbl}\PY{p}{(}
  \PY{n+nf}{head}\PY{p}{(}\PY{n}{mtcars}\PY{p}{)}\PY{p}{,}
  \PY{n}{format} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{markdown\PYZdq{}}\PY{p}{,}
  \PY{c+c1}{\PYZsh{}col.names = c(\PYZdq{}Measure\PYZdq{}, \PYZdq{}*M*\PYZdq{}, \PYZdq{}*SD*\PYZdq{}, \PYZdq{}*M*\PYZdq{}, \PYZdq{}*SD*\PYZdq{}),}
  \PY{n}{digits} \PY{o}{=} \PY{l+m}{2}\PY{p}{,}
  \PY{n}{caption} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Means and Standard Deviations of Three Measures of Graduate Programs of Education (\PYZdl{}n=122\PYZdl{})\PYZdq{}}\PY{p}{)}

\PY{c+c1}{\PYZsh{} print(as.character(table\PYZus{}kbl))}
\PY{n+nf}{display\PYZus{}markdown}\PY{p}{(}\PY{n+nf}{as.character}\PY{p}{(}\PY{n}{table\PYZus{}kbl}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0735}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0735}}@{}}
\caption{Means and Standard Deviations of Three Measures of Graduate
Programs of Education (\(n=122\))}\tabularnewline
\toprule()
...
\PY{n+nf}{library}\PY{p}{(}\PY{n}{kableExtra}\PY{p}{)}
\PY{n+nf}{library}\PY{p}{(}\PY{n}{IRdisplay}\PY{p}{)}

\PY{n+nf}{head}\PY{p}{(}\PY{n}{mtcars}\PY{p}{)} \PY{o}{\PYZpc{}\PYZgt{}\PYZpc{}}
  \PY{n+nf}{kable}\PY{p}{(}
    \PY{n}{format} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{markdown\PYZdq{}}\PY{p}{,}
    \PY{n}{digits} \PY{o}{=} \PY{l+m}{2}\PY{p}{,}
    \PY{n}{caption} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Means and Standard Deviations of Three Measures of Graduate Programs of Education (\PYZdl{}n=122\PYZdl{})\PYZdq{}}\PY{p}{)} \PY{o}{\PYZpc{}\PYZgt{}\PYZpc{}}
  \PY{n+nf}{as.character}\PY{p}{(}\PY{p}{)} \PY{o}{\PYZpc{}\PYZgt{}\PYZpc{}}
  \PY{n+nf}{display\PYZus{}markdown}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nf}{kable}\PY{p}{(}
    ...
    \PY{n}{format} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{markdown\PYZdq{}}\PY{p}{,}
    \PY{n}{digits} \PY{o}{=} \PY{l+m}{2}\PY{p}{,}
    \PY{n}{caption} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Means and Standard Deviations of Three Measures of Graduate Programs of Education (\PYZdl{}n=122\PYZdl{})\PYZdq{}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{sum}\PY{p}{(}\PY{n}{df\PYZus{}multiply\PYZus{}test}\PY{p}{[}\PY{n+nf}{c}\PY{p}{(}\PY{l+m}{1}\PY{o}{:}\PY{l+m}{3}\PY{p}{)}\PY{p}{,} \PY{n}{col.result}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} multiply columns of dataframe and store the result in a new column}
\PY{n}{df\PYZus{}multiply\PYZus{}test}\PY{o}{\PYZdl{}}\PY{n}{col.result} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n}{df\PYZus{}multiply\PYZus{}test}\PY{o}{\PYZdl{}}\PY{n}{col.a} \PY{o}{*} \PY{n}{df\PYZus{}multiply\PYZus{}test}\PY{o}{\PYZdl{}}\PY{n}{col.b}

...
Dependencies for \texttt{magick}:\\
- \texttt{libcurl4-openssl-dev} - \texttt{libmagick++-dev}

Dependencies for \texttt{ahpsurvey}:\\
...
\PY{n}{df\PYZus{}attributes\PYZus{}labels\PYZus{}all} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{data.table}\PY{p}{(}
  ...
  \PY{n}{labels} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Local microclimate and hydrology regulation\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Biodiversity\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Circular economy\PYZdq{}}\PY{p}{,}
             \PY{l+s}{\PYZdq{}}\PY{l+s}{Knowledge sharing and education \PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Community building and social justice\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Participation in food production\PYZdq{}}\PY{p}{,}
             \PY{l+s}{\PYZdq{}}\PY{l+s}{Food quality and safety\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Local value chains/networks\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{Affordability of food for all social strata\PYZdq{}}\PY{p}{,}
...
\end{tcolorbox}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_44_0.png}\end{center}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_44_2.png}\end{center}
        \caption{Violins displaying priorities and consistency ratios of all participants}
        \label{fig:violins_all_attributes}
    \end{figure}
...
\end{tcolorbox}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_51_0.png}\end{center}
        \caption{Violins displaying priorities and consistency ratios of participants of practitioners and experts}
        \label{fig:violins_all_attributes}
    \end{figure}
    
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_51_1.png}\end{center}
        \caption{Violins displaying priorities and consistency ratios of participants of practitioners and experts}
        \label{fig:violins_all_attributes}
    \end{figure}
    
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_51_2.png}\end{center}
        \caption{Violins displaying priorities and consistency ratios of participants of practitioners and experts}
        \label{fig:violins_all_attributes}
    \end{figure}
    
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_51_3.png}\end{center}
        \caption{Violins displaying priorities and consistency ratios of participants of practitioners and experts}
        \label{fig:violins_all_attributes}
    \end{figure}

...
\PY{n}{func\PYZus{}process\PYZus{}ahpsurvey} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{function}\PY{p}{(}\PY{n}{df\PYZus{}csvInputFiles}\PY{p}{,} \PY{n}{str\PYZus{}participants\PYZus{}group}\PY{p}{,} \PY{n}{str\PYZus{}input\PYZus{}path}\PY{p}{,} \PY{n}{str\PYZus{}output\PYZus{}path}\PY{p}{,} \PY{n}{df\PYZus{}attributes\PYZus{}labels}\PY{p}{)} \PY{p}{\PYZob{}}
    ...
    \PY{n+nf}{for }\PY{p}{(} \PY{n}{file\PYZus{}idx} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{nrow}\PY{p}{(}\PY{n}{df\PYZus{}csvInputFiles}\PY{p}{)} \PY{p}{)} \PY{p}{\PYZob{}}
        ...
        \PY{c+c1}{\PYZsh{} generate an extended data frame with consistency ratios}
    ...
    \PY{c+c1}{\PYZsh{} write data frame \PYZsq{}df\PYZus{}outputTable\PYZsq{} to CSV file for further statistical analysis}
...
\PY{n+nf}{for }\PY{p}{(} \PY{n}{file\PYZus{}idx} \PY{n}{in} \PY{l+m}{1}\PY{o}{:}\PY{n+nf}{nrow}\PY{p}{(}\PY{n}{df\PYZus{}csvInputFiles}\PY{p}{)} \PY{p}{)} \PY{p}{\PYZob{}}
    ...
    \PY{n+nf}{cat}\PY{p}{(}\PY{n+nf}{sprintf}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Aggregated preference weights for \PYZpc{}s:\PYZbs{}n\PYZdq{}}\PY{p}{,} \PY{n}{str\PYZus{}file\PYZus{}description}\PY{p}{)}\PY{p}{)}
    \PY{n+nf}{print.data.frame}\PY{p}{(}\PY{n}{df\PYZus{}gmean}\PY{p}{,} \PY{n}{right}\PY{o}{=}\PY{k+kc}{TRUE}\PY{p}{)}
    \PY{n+nf}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
\PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
Aggregated preference weights for criteria (main criteria):
...
Aggregated preference weights for environmental sub-criteria:
     gmean.raw gmean.norm
Clim 0.2741300  0.3089871
BDiv 0.3291718  0.3710277
CiEc 0.2838874  0.3199852
Sum  0.8871892  1.0000000

Aggregated preference weights for social sub-criteria:
     gmean.raw gmean.norm
KEdu 0.3018698  0.3512801
Comm 0.3212634  0.3738480
Part 0.2362090  0.2748719
Sum  0.8593422  1.0000000

Aggregated preference weights for economic sub-criteria:
     gmean.raw gmean.norm
Qual 0.2329901  0.2625724
LVCs 0.3666029  0.4131498
Affo 0.2877435  0.3242777
Sum  0.8873365  1.0000000

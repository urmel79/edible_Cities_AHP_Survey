...
\end{tcolorbox}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_46_0.png}\end{center}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_46_2.png}\end{center}
        \caption{Violins displaying priorities and consistency ratios of participants of non-governmental organizations}
        \label{fig:violins_all_attributes}
    \end{figure}
...
\end{tcolorbox}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_48_0.png}\end{center}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ahpsurvey_all_files/ahpsurvey_all_48_2.png}\end{center}
        \caption{Violins displaying priorities and consistency ratios of participants of practitioners and experts}
        \label{fig:violins_all_attributes}
    \end{figure}
